...
if (!isset($_SESSION["mikhmon"])) {
  ...
  if ($hotspot == "dashboard" || substr(end(explode("/", $url)), 0, 8) == "?session") {
	...
	$sweb1 = "menu-open";
  } elseif ($hotspot == "wawebhook") {
    $swab = "active";
	$mpage = "Setting WhatsApp Bot";
	$sweb1 = "menu-open";
  } elseif ($hotspot == "whreport") {
    $swhr = "active";
    $swhreport = "active";
	$mpage = "Report Web Hook";
	$sweb1 = "menu-open";
  } elseif ($hotspot == "skouta") {
    $skt = "active";
    $skouta = "active";
	$mpage = "Setting Qouta";
	$ssk = "menu-open";
...
<?php if (($id == "settings" && $session == "new") || $id == "webhook" || $id == "whreport" || $id == "settings" && $router == "new") 
{

}else if ($id == "settings" || $id == "editor"|| $id == "uplogo" || $id == "webhook" || $id == "wawebhook" || $id == "whreport" || $id == "connect"){
?>  
