...
if (!isset($_SESSION["mikhmon"])) {
  ...
  //	require_once './webhook/system.database.php';
  include_once './webhook/system.database.php';
  ...
  if (isset($_POST['save'])) {
    ...
    $nowa1 = nomor($_POST['nowa']);
    $mtulis = $nowa1."|apiwa|".ucwords($_POST['nama'])."|".$mkey."|";
    ...
    $nama = $_POST['nama'];
    $simpan = apkdaftars($nowa1, ucwords($nama), "ALL", $mkey, "");
    $nama = str_replace(' ', '%20', ucwords($_POST['nama']));
    $urlpath = $_SERVER['REQUEST_URI'];
    $ltopup = $cekhttps.$_SERVER['HTTP_HOST'].str_replace('admin.php?id=sessions', 'webhook/mikhmon.php', $urlpath);
    $pesan = "Session\nAktifasi link ADMIN :\n\nSilahkan klik link dibawah ini, untuk melakukan Aktifasi.\n\n".$ltopup."?nomor=".$nowa1."&nama=".$nama."&key=".$mkey."\n";

    $kirim = kirimwaid($nowa1, $pesan);
    //		$kirim=rappkirimwa($nowa1,"test");
    //		$kirim1=kirimtele($pesan);
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-6">
            <form autocomplete="off" method="post" action="">
              <div class="card">
                ...
                <tr>
                  <td class="align-middle">ID WhatsApp</td><td><input class="form-control" id="useradm" type="number" size="15" name="nowa" title="Nomor WA Anda" value="<?= $nowa; ?>"></td>
                </tr>
                <tr>
                  <td class="align-middle">Nama </td><td><input class="form-control" id="useradm" type="text" size="15" name="nama" title="Nama Anda" value="<?= $nama; ?>"></td>
                </tr>
                -->
                <tr>
                ...
                <tr>
                  ...
                  <div class="input-group-2">
                    <div style="cursor: pointer;" class="group-item group-item-r pd-2p5 text-center" onclick="location.reload();" title="Reload Data">
          ...
          <div>
            <b id="newVer" class="text-green"></b>
          </div>
        </div>
      </div>
    </form>
